...
<!-- Header Banner -->
<section class="gallery-header-banner d-flex align-items-center justify-content-center text-center" style="position:relative;min-height:320px;background:linear-gradient(120deg,#ffc722 0%,#ff7b00 60%,#ff2e63 100%);overflow:hidden;">
